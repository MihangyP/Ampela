                ...
                <View style={styles.checkboxContainer}>
                    <View style={styles.checkboxItem}>
                        ...
                        <Pressable onPress={handleCheckbox1Press}>
                            <Text style={styles.checkboxText}>Oui, je suis un personnel de santé (Gynécologue, sage femme)</Text>
                        </Pressable>
                    </View>
                    <View style={styles.checkboxItem}>
                        <BouncyCheckbox
                        ...
                        <Pressable onPress={handleCheckbox2Press}>
                            <Text style={styles.checkboxText}>Non, je ne suis qu'un simple utilisateur</Text>
                        </Pressable>
                    </View>
                </View>
            </View>
