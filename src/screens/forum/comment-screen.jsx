...
const CommentScreen = ({navigation, route}) => {
    ...
    const { post, refToCommentItem } = route.params;
    ...
    return (
        <>
        <HeaderWithGoBack navigation={navigation} title="Commentaires" />
        <ScrollView style={styles.container} ref={refToCommentItem}>
